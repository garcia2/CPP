...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/25 13:20:52 by nigarcia          #+#    #+#             */
/*   Updated: 2024/01/25 13:20:54 by nigarcia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScalarConverter::convertFloat(float number) {
	...
	ScalarConverter::printChar(static_cast<char>(number), (number < 0.0f || number > 127.0f || std::isnan(number) || isinff(number)));
	ScalarConverter::printInt(static_cast<int>(number), (std::isnan(number) || isinff(number)));
